...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2018 at 03:37 PM
...
--
-- Dumping data for table `akademik_waktu_kuliah`
--
...
(41, 'Didik Indrayana', '', '', '', 'Sukabumi', '0000-00-00', '1', 1, 1, '', 'Perum.Taman Asri BLK B.19 RT.05 RW.14\r\n081312332105', '085861234568', 'azfa_rasikh@yahoo.co.id', 2);
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2018-08-01 20:34:20'),
(4, 'informatika', '', '21232f297a57a5a743894a0e4a801fc3', 2, '6', '2018-07-19 09:58:08'),
(6, 'nuris', 'nuris akbar', '21232f297a57a5a743894a0e4a801fc3', 2, '1', '2018-07-19 11:46:17'),
(30, 'dicsr', 'Didik Indrayana', '21232f297a57a5a743894a0e4a801fc3', 4, '28', '2018-08-01 20:29:10'),
(31, 'dik', 'Didik Indrayana', '21232f297a57a5a743894a0e4a801fc3', 3, '41', '2018-08-01 20:30:27'),
(32, 'admin', '', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2018-08-01 20:34:20');
...
--
-- Table structure for table `pengajuan_jenis_status`
--

CREATE TABLE IF NOT EXISTS `pengajuan_jenis_status` (
`jenis_bayar_id` int(11) NOT NULL,
  `keterangan` varchar(50) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=12 ;

--
-- Dumping data for table `pengajuan_jenis_status`
--
...
--
-- Table structure for table `pengajuan_jenis_surat`
--

CREATE TABLE IF NOT EXISTS `pengajuan_jenis_surat` (
`jenis_bayar_id` int(11) NOT NULL,
  `keterangan` varchar(50) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=12 ;

--
-- Dumping data for table `pengajuan_jenis_surat`
--
...
--
-- Table structure for table `pengajuan_surat_detail`
--

CREATE TABLE IF NOT EXISTS `pengajuan_surat_detail` (
`pembayara_detail_id` int(11) NOT NULL,
  `tanggal` datetime NOT NULL,
  `nim` varchar(11) NOT NULL,
  `jenis_bayar_id` int(11) NOT NULL,
...
--
-- Dumping data for table `pengajuan_surat_detail`
--
...
--
-- Table structure for table `pengajuan_surat_kuliah`
--

CREATE TABLE IF NOT EXISTS `pengajuan_surat_kuliah` (
`biaya_kuliah_id` int(11) NOT NULL,
  `jenis_bayar_id` int(3) NOT NULL,
  `konsentrasi_id` int(3) NOT NULL,
  `angkatan_id` int(3) NOT NULL,
...
--
-- Dumping data for table `pengajuan_surat_kuliah`
--
...
(5, 'KA131002', 'Etika Cahya Pribadi', 1, 1, '', 0, '1', 1, '', '0000-00-00', '', '', '', 1, 1, '', '', 0, 0, '', '', '', '', 0, '', '', '', '', 0, '', '', '', '', '', '', 0, 0, 4),
...
(28, '66666666', 'Didik Indrayana', 1, 1, 'Perum.Taman Asri BLK B.19 RT.05 RW.14\r\n081312332105', 0, '1', 1, 'Sukabumi', '2018-07-26', '', '', '', 1, 1, '', '', 0, 0, '', '', '', '', 0, '', '', '', '', 0, '', '', '', '', '', '', 0, 0, 0);
...
ALTER TABLE `app_dosen`
 ADD PRIMARY KEY (`dosen_id`), ADD KEY `nama_lengkap` (`nama_lengkap`);
...
ALTER TABLE `makul_matakuliah`
 ADD PRIMARY KEY (`makul_id`), ADD KEY `sks` (`sks`);
...
--
-- Indexes for table `pengajuan_jenis_status`
--
ALTER TABLE `pengajuan_jenis_status`
 ADD PRIMARY KEY (`jenis_bayar_id`);

--
-- Indexes for table `pengajuan_jenis_surat`
--
ALTER TABLE `pengajuan_jenis_surat`
 ADD PRIMARY KEY (`jenis_bayar_id`);

--
-- Indexes for table `pengajuan_surat_detail`
--
ALTER TABLE `pengajuan_surat_detail`
 ADD PRIMARY KEY (`pembayara_detail_id`);

--
-- Indexes for table `pengajuan_surat_kuliah`
--
...
MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pengajuan_jenis_status`
--
ALTER TABLE `pengajuan_jenis_status`
MODIFY `jenis_bayar_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `pengajuan_jenis_surat`
--
ALTER TABLE `pengajuan_jenis_surat`
MODIFY `jenis_bayar_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `pengajuan_surat_detail`
--
ALTER TABLE `pengajuan_surat_detail`
MODIFY `pembayara_detail_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `pengajuan_surat_kuliah`
--
ALTER TABLE `pengajuan_surat_kuliah`
MODIFY `biaya_kuliah_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=943;
--
