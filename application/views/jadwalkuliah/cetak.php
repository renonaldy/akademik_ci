...
<h3 style="border: 1px solid #000;padding: 10px;">JADWAL KULIAH <BR>SEMESTER GENAP TAHUN AKADEMIK 2017-2018</h3>
<table>
    <tr>
        <td rowspan="3"><img src="<?php echo base_url()?>assets/images/logo.png" width="100" style="float: left;margin-right: 10px;">
            <h3>WIYATA INDONESIA</h3>
                        Jalan Gudang 7-9 , Kebonjati-Cikole ,Kota Sukabumi<br>				
                        Telp.(0266) 1234567 ,Fax(0266) 987654321<br>							
                        E-mail : http://www.imwi.ac.id</td>
