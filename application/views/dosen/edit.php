...
<table class="table table-bordered">
    ...
    <td width="150">Nama Lengkap</td><td>
        <?php echo inputan('text', 'nama','col-sm-5','Nama Lengkap ..', 1, $r['nama_lengkap'],'');?>
    </td>
    </tr>
    ...
    <td width="150">Tempat ,Tanggal Lahir</td><td>
        ...
        <?php echo inputan('text', 'tanggal_lahir','col-sm-3','Tanggal Lahir ..', 1, $r['tanggal_lahir'],array('id'=>'datepicker'));?>
    </td>
    </tr>
    ...
    <td width="150">No Hp ,Email</td><td>
        <?php echo inputan('text', 'hp','col-sm-3','No HP ..', 1, $r['hp'],'');?> 
         <?php echo inputan('email', 'email','col-sm-5','Email ..', 1, $r['email'],'');?>
    </td>
    </tr>
	<td width="150">Prodi</td><td>
         <?php echo editcombo('prodi','akademik_prodi','col-sm-5','nama_prodi','prodi_id','','',$r['prodi_id']); ?>
