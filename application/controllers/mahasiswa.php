    ...
    function post()
    {
        if(isset($_POST['submit']))
        {
		   ...
		   $username       =   $this->input->post('username');
            ...
            $this->db->insert($this->tables,$pribadi);
            $id             = getField('student_mahasiswa', 'mahasiswa_id', 'nama', $nama);
            $account        = array('username'=>$username,'password'=>  md5($password),'nama'=>$nama,'keterangan'=>$id,'level'=>4);
