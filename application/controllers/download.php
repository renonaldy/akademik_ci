...
class download extends CI_Controller
{
    ...
    var $title  =   "Seting Upload & Download File";
    ...
    function index()
    {
        ...
        $this->template->load('template', 'download/view',$data);
    }
...
function simpanstatus()
    ...
    function bayar()
    {
        ...
        else
        {
            ...
            $this->template->load('template', 'download/bayar/view',$data);
        }
    }
