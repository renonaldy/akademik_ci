...
class cetak extends CI_Controller
{
    ...
    function cetakkhs()
    {
       ...
       $pdf->Cell(130, 5, 'WIYATA INDONESIA', 0, 1, 'C');
       $pdf->SetFont('TIMES','',10);
       $pdf->Cell(130, 5, 'Jalan Gudang 7-9 , Kebonjati-Cikole ,Kota Sukabumi', 0, 1, 'C');
       $pdf->Cell(130, 5, 'Telp.(0266) 1234567 ,Fax(0266) 987654321', 0, 1, 'C');
       $pdf->Cell(130, 5, 'E-mail : http://www.imwi.ac.id', 0, 1, 'C');
    ...
    function kum()
    {
        ...
        $pdf->Cell(100,2,'WIYATA INDONESIA',0,1);
        
        $pdf->SetFont('TIMES','',10);
        $pdf->Cell(100, 6, 'Jalan Gudang 7-9 , Kebonjati-Cikole ,Kota Sukabumi', 0, 1, 'L');
         $pdf->Cell(100, 3, 'E-mail : http://www.imwi.ac.id ; Website : http://www.imwi.ac.id', 0, 1, 'L');
        $pdf->Cell(100, 5, 'Telp / Fax : (0266) 12345678', 0, 1, 'L');
        ...
        $pdf->Text(131, 33, 'SEMESTER GANJIL T.A  2017/2018');
        $pdf->SetFont('TIMES','',10);
       ...
       $pdf->Cell(300,3,'                 atau pengawas ujian,jika KUM tidak dibawa harus minta surat keterangan dari akademik.',0,1);
        $pdf->SetFont('times','',10);
       $pdf->Text(155, 110, 'Sukabumi , '.  tgl_indo(waktu()));
       $pdf->Text(155, 115, 'Pembantu Direktur I');
       
       $pdf->Text(155, 130, 'Prof.Dr.Dosen,M.T.,M.Kom');
       $pdf->Output();
    }
